...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`HR Management Application skytrough`}</title>

        <meta
          name="description"
          content="Unleash your team's potential with Skytrough, your comprehensive solution for efficient HR Management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`HR Management Application skytrough`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash your team's potential with Skytrough, your comprehensive solution for efficient HR Management.`}
            </Text>
            <Box
